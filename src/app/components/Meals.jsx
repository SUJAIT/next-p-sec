...
const Meals = () => {
  ...
  return (
       ...
       <div className='mt-12'>
       <input onChange={handler} className='p-4 outline-none border-transparent outline-black'  type="text" placeholder='search meals'/>
   <button onClick={() => loadData()} className='bg-red-400 p-5'>Search</button>
